...
def main():
    ...
    if use_capture == True:
        ...
        lidar_generator = ld.get_raw_lidar_data(raw_lidar_data, start_frame = start_frame*2)
    ...
    '''
    Intended structure when all timestamps are avaiable
    while(True):
        
        data_type, data, curr_lidar, curr_cam, curr_pos = sf.data_handler(curr_lidar, curr_cam, curr_pos, lidar_generator, image_generator, pos_generator)

...
def run(start_stamp):
    ...
    while(True):
        ...
        if data_type == 'lid':
            ...
            data = cd.set_cam_offset(last_position[2]-45, detections,[0.10+last_position[0],0.0+last_position[1]])
            if data != []:
                bang = bang + data
        elif data_type == 'pos':
        ...
        plot_data = [data_type, thresholded_raw, lm_plot,current_lines, detections, curr_track, curr_cam[1], bang]
